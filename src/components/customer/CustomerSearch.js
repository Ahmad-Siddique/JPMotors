...
const SearchField = ({ label }) => (
    <Box display="flex" alignItems="center" gap={1} style={{ margin: "8px",width: "350px" }}>
        <TextField
            label={label}
            variant="outlined"
    ...
    return (
        ...
        >
            ...
            <Box display="flex" alignItems="center" gap={2}>
                <SearchField label="By Name" />
                <SearchField label="By Mobile / Telephone" />
                <SearchField label="By Email" />
            </Box>
        </Box>
    );
};
